...
- Name: sortingFiltering.spec.js >> Search, Sorting, Filtering, and Pagination Tests >> Sort Ascending
- Location: tests\sortingFiltering.spec.js:28:3
...
Locator: getByRole('button', { name: /sort.*ascending/i })
Expected: visible
Timeout: 1000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /sort.*ascending/i })
