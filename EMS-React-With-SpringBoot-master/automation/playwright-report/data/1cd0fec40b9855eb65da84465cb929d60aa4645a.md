...
- Name: sortingFiltering.spec.js >> Search, Sorting, Filtering, and Pagination Tests >> Previous Page
- Location: tests\sortingFiltering.spec.js:58:3
...
Locator: getByRole('button', { name: /previous/i })
Expected: visible
Timeout: 1000ms
