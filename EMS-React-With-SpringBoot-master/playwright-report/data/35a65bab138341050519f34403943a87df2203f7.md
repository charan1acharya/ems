...
- Name: sortingFiltering.spec.js >> Search, Sorting, Filtering, and Pagination Tests >> Clear Filter
- Location: tests\sortingFiltering.spec.js:46:3
...
Locator: getByRole('button', { name: /clear filter/i })
Expected: visible
Timeout: 1000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /clear filter/i })
