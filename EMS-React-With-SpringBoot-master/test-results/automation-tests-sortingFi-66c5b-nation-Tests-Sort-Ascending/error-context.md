...
- Name: automation\tests\sortingFiltering.spec.js >> Search, Sorting, Filtering, and Pagination Tests >> Sort Ascending
- Location: automation\tests\sortingFiltering.spec.js:28:3
