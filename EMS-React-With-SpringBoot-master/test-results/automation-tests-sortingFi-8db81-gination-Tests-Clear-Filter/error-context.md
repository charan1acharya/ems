...
- Name: automation\tests\sortingFiltering.spec.js >> Search, Sorting, Filtering, and Pagination Tests >> Clear Filter
- Location: automation\tests\sortingFiltering.spec.js:46:3
