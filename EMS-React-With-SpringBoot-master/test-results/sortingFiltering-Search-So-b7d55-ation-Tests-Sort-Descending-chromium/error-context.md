...
- Name: sortingFiltering.spec.js >> Search, Sorting, Filtering, and Pagination Tests >> Sort Descending
- Location: tests\sortingFiltering.spec.js:34:3
...
Locator: getByRole('button', { name: /sort.*descending/i })
Expected: visible
Timeout: 1000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /sort.*descending/i })
